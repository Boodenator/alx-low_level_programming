...
/**
 * _binary_search - Searching for value in sorted array
 *                  of ints using binary search.
 * @array: Ptr to first element of the array to search.
 * @left: Start index of the [sub]array to search.
 * @right: END index of the [sub]array to search.
 * @value: search value.
 *
 * Return: If the value is not present or the array is NULL, -1.
 *         Else, the index where the value is located.
 *
 * Description: Print out [sub]array searched after each change.
 */
